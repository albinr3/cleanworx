  ...
  return (
    <section className="relative w-full h-[400px] sm:h-[500px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-black/50 backdrop-blur-md px-4 py-1.5 text-xs sm:text-sm font-semibold tracking-wider text-white uppercase mb-4">
        ...
        <div className="mt-8">
          <button
            ...
            className="inline-flex items-center gap-2 rounded-md bg-[#e30613] px-8 py-3.5 text-sm font-bold text-white shadow-xl shadow-[#e30613]/30 hover:bg-[#c5040f] hover:scale-105 transition-all cursor-pointer"
          >
