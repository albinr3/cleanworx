...
export function CtaBanner({ onOpenBooking }: CtaBannerProps) {
  return (
    <section className="relative w-full bg-[#e30613] py-16 lg:py-20 overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 text-center lg:text-left">
          ...
          <div className="flex-shrink-0">
            <button
              ...
              className="inline-flex items-center gap-3 rounded-md bg-[#0a0a0c] px-8 py-4 text-base font-bold text-white shadow-2xl hover:bg-neutral-900 hover:scale-105 transition-all cursor-pointer"
            >
